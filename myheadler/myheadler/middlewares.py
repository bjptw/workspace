...
class MyheadlerSpiderMiddleware(object):
...
class MyheadlerDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
import random
import base64
from myheadler.settings import USER_AGENTS
from myheadler.settings import PROXIES
